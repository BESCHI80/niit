<%-- 
    Document   : get1
    Created on : 27 May, 2021, 5:40:58 PM
    Author     : admin
--%>
...
PreparedStatement ps=con.prepareStatement("select ans from quizques where quizname='"+name+"' and qid='"+count1+"' ");
...
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinequiz","root","admin");
PreparedStatement ps=con.prepareStatement("select ans from quizques where quizname='"+name+"' and qid='"+max+"' ");
ResultSet rs=ps.executeQuery();
if(rs.next()){
String ans1=rs.getString(1);

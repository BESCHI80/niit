<%-- 
    Document   : start
    Created on : 21 May, 2021, 10:13:21 PM
    Author     : admin
--%>
...
<div class="left_content">
             <% 
            	...
            	<div class="calendar_box2">
					...
					<tr><td><input type="radio" name="radio" value="<%=opt1%>" /><%=opt1%></td></tr>	
					<tr><td><input type="radio" name="radio" value="<%=opt2%>"/><%=opt2 %></td></tr>	
					<tr><td><input type="radio" name="radio" value="<%=opt3%>"/><%=opt3 %></td></tr>	
					<tr><td><input type="radio" name="radio" value="<%=opt4%>"/><%=opt4 %></td></tr>			

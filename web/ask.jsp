<%-- 
    Document   : ask
    Created on : 21 May, 2021, 1:04:29 PM
    Author     : admin
--%>
...
<span class="orange">Address:</span> H-109,a-block,chennai<br>
...
<span class="orange">Email:</span> <a href="rishi.kumar91@facebook.com">info@company.com</a><br>
                  ...
                  <div id="contact_form">
                   ...
                   <form action="askq.jsp">
                    ...
                    <div class="form_row">
                    <label>Question:</label><textarea name="ques" class="contact_textarea"></textarea>
                    </div> 
